...
class LandingPageSectionSerializerTestCase(TestCase):
    def test_data(self):
        section = LandingPageSectionFactory.create(name="Processen en activiteiten", icon="account_tree")
    ...
    def test_data_nested(self):
        section = LandingPageSectionFactory.create(name="Processen en activiteiten", icon="account_tree")
        section.links.set(
            LandingPageLinkFactory.create_batch(3, icon="post_add", label="Nieuwe taak starten", href="/zaak-starten"))
        serializer = LandingPageSectionSerializer(section)
        data = serializer.data
